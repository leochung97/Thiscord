...
function Conversation(props) {
  ...
  useEffect(() => {
    ...
    const cable = createConsumer("wss://thiscord-leo.herokuapp.com/cable");
    const paramsToSend = {
    ...
    return (
      <div className="channel-shell">
        <header className="channel-header">
          ...
          <div className="conversation-name">{props.user.username}</div>
...
const grabUser = (state, ownProps) => {
  let conversation =
    state.entities.conversations[ownProps.match.params.conversationId];
  if (conversation) {
